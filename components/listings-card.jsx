...
export default function ListingsCard({ user, reservationsData, listing, showSecondaryBtn = false, secondaryBtnLabel, onAction }) {
    ...
    return <div onClick={() => router.push(`/listings/${listing.id}`)} className="p-3 rounded-lg shadow border border-e-gray-200 relative cursor-pointer group hover:shadow-lg transition-all">
        ...
        <div className="text-gray-600">
            {countryDetails?.label || listing.locationValue},&nbsp;
